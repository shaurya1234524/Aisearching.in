...
urlpatterns = [
    ...
    path('sitemapss', lambda x: HttpResponse(open('https://shaurya-bucket1222333223123.s3.eu-north-1.amazonaws.com/admin/6234381_28.xml').read(), content_type='application/xml')),
